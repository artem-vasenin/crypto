...
func TestMonitor_UpdatePosition_UpdatesExistingPosition(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_RemovesClosedPosition(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_DoesNotCreateDuplicate(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_MultiplePositions(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_UpdatesOnlyMatchingPosition(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_UpdatesPositionWhenSideChanges(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_Position_ReturnsPosition(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_Position_ReturnsFalseWhenPositionNotFound(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_Position_DistinguishesPositionIdx(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_ReturnsOpenedEvent(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_ReturnsUpdatedEvent(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_ReturnsClosedEvent(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_DetectsMultipleChanges(
	t *testing.T,
) {
	monitor := New()
...
func TestMonitor_UpdatePosition_DetectsNoChanges(
	t *testing.T,
) {
	monitor := New()
