...
// Instrument описывает доступный USDT linear perpetual контракт.
...
// Ticker содержит текущий snapshot рынка.
type Ticker struct {
	Symbol            string  `json:"symbol"`
...
// Levels содержит ближайшие уровни и производные характеристики диапазона.
type Levels struct {
...
// OrderBookMetrics показывает ликвидность непосредственно рядом с текущей ценой.
